...
!GIT_COMMITTER_NAME && (process.env.GIT_COMMITTER_NAME = "sulaiman-coder");
!GIT_COMMITTER_EMAIL && (process.env.GIT_COMMITTER_EMAIL = "51925710+sulaiman-coder@users.noreply.github.com");
